    ...
    */
    ...
    'providers' => [
        'anthropic' => [
            ...
            'retries' => (int) env('ANTHROPIC_RETRIES', 3),
        ...
        'gemini' => [
            ...
            'retry_sleep_ms' => (int) env('GEMINI_RETRY_SLEEP_MS', 200),
        ...
        'moonshot' => [
            ...
            'rpm_limit' => (int) env('MOONSHOT_RPM_LIMIT', 18),
            'timeout' => (int) env('MOONSHOT_TIMEOUT', 60),
